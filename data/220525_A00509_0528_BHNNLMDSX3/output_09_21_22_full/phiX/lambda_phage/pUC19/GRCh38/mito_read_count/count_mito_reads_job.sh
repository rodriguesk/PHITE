...
bam_file="/oak/stanford/groups/smontgom/kameronr/CF_DNA_methylation/data/220525_A00509_0528_BHNNLMDSX3/output_09_21_22_full/phiX/lambda_phage/pUC19/GRCh38/mito_read_count/BAMs"
...
output_file="$output_dir/mito_read_count_${base_name}.txt"
...
samtools view -c -@ 2 -o "$output_file" "$input_bam" chrM
